...
export default function Wellbeing() {
    ...
    const questions = [
        ...
        {
			questionText: 'I have been looking after my physical health (exercise, healthy eating)',
			answerOptions: [
				{ answerText: 'None of the time', healthPoints: 0 },
                { answerText: 'Rarely', healthPoints: 1 },
                { answerText: 'Some of the time', healthPoints: 2 },
    ...
    const getScoreDescription = (score_) => {
        if (score_ < 15 ) {
            return <div><h4>Your well-being score implies to us that you may be having a hard time,  please reach out and get in touch. Here are some support helplines to start with:</h4><li>
                Student Support Exeter - 01392 263018</li>
                <li>Mind UK (confidential mental health support) - 0300 123 3393</li></div>
        } else if (score >=15 && score < 25){
            return <div><h4>Your well-being score implies to us that you are doing okay, but may need some help.</h4>
            <br></br> Please consider getting in touch with your personal tutor.</div>
        } else {
            return <div>Your score indicates that you are doing ok! Please continue to stay on-top of your well-being and know we are here to help. <br></br>For more information, visit The University of Exeter website.</div>
        }
    }
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                <main className={styles.main}>
                    ...
                    <p className={styles.description}>
                        Take a confidential well-being assessment, none of this data is saved.
                    </p>
